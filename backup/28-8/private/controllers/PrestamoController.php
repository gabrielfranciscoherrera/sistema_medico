...
class PrestamoController {
    ...
    public function create($data) {
        ...
        if (empty($data->id_cliente) || empty($data->monto_aprobado) || empty($data->tasa_interes_anual) || empty($data->plazo) || empty($data->frecuencia_pago) || empty($data->monto_cuota)) {
        ...
        $this->prestamo->monto_cuota = $data->monto_cuota;
        $this->prestamo->fecha_solicitud = date('Y-m-d');
